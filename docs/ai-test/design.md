...
> | 文档 | 作用 |
> | --- | --- |
> | [`requirements.md`](requirements.md) | 业务背景、功能/非功能需求、验收标准 |
> | [`architecture.md`](architecture.md) | 整体架构总览（5 大模块、语言分层、关键协议、部署） |
> | [`test-case-management-design.md`](test-case-management-design.md) | **用例管理（TCM）** 详细设计 |
> | [`execution-framework-design.md`](execution-framework-design.md) | **执行框架（EXF）** 详细设计（含并发、高性能、Rust 演进） |
